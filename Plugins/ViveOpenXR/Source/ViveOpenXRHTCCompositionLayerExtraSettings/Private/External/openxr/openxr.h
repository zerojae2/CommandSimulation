...
// XR_HTC_composition_layer_extra_settings is a preprocessor guard. Do not pass it to API calls.
#define XR_HTC_composition_layer_extra_settings 1
#define XR_HTC_composition_layer_extra_settings_SPEC_VERSION 1
#define XR_HTC_COMPOSITION_LAYER_EXTRA_SETTINGS_EXTENSION_NAME "XR_HTC_composition_layer_extra_settings"

static const XrStructureType XR_TYPE_SYSTEM_COMPOSITION_LAYER_EXTRA_SETTINGS_PROPERTIES_HTC = ((XrStructureType)1000323000U);
// #define XR_TYPE_SYSTEM_COMPOSITION_LAYER_EXTRA_SETTINGS_PROPERTIES_HTC ((XrStructureType) 1000323000U)
#define XR_TYPE_COMPOSITION_LAYER_SHARPENING_SETTING_HTC ((XrStructureType) 1000323001U)
#define XR_TYPE_COMPOSITION_LAYER_SUPER_SAMPLING_SETTING_HTC ((XrStructureType) 1000323002U)


typedef enum XrSharpeningModeHTC {
    XR_SHARPENING_MODE_FAST_HTC = 0,
    XR_SHARPENING_MODE_NORMAL_HTC = 1,
    XR_SHARPENING_MODE_QUALITY_HTC = 2,
    XR_SHARPENING_MODE_AUTOMATIC_HTC = 3,
    XR_SHARPENING_MODE_MAX_ENUM_HTC = 0x7FFFFFFF
} XrSharpeningModeHTC;

typedef enum XrSuperSamplingModeHTC {
    XR_SUPER_SAMPLING_MODE_FAST_HTC = 0,
    XR_SUPER_SAMPLING_MODE_NORMAL_HTC = 1,
    XR_SUPER_SAMPLING_MODE_QUALITY_HTC = 2,
    XR_SUPER_SAMPLING_MODE_AUTOMATIC_HTC = 3,
    XR_SUPER_SAMPLING_MODE_MAX_ENUM_HTC = 0x7FFFFFFF
} XrSuperSamplingModeHTC;

typedef struct XrSystemCompositionLayerExtraSettingsPropertiesHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrBool32                    supportsSharpening;
    XrBool32                    supportsSuperSampling;
} XrSystemCompositionLayerExtraSettingsPropertiesHTC;

typedef struct XrCompositionLayerSharpeningSettingHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrSharpeningModeHTC         mode;
