...
#ifndef XR_HTC_anchor_persistence

// XR_HTC_anchor_persistence is a preprocessor guard. Do not pass it to API calls.
#define XR_HTC_anchor_persistence 1
XR_DEFINE_HANDLE(XrPersistedAnchorCollectionHTC)
#define XR_HTC_anchor_persistence_SPEC_VERSION 1
#define XR_HTC_ANCHOR_PERSISTENCE_EXTENSION_NAME "XR_HTC_anchor_persistence"
#define XR_OBJECT_TYPE_PERSISTED_ANCHOR_COLLECTION_HTC ((XrObjectType) 1000324000U)
#define XR_TYPE_PERSISTED_ANCHOR_COLLECTION_ACQUIRE_INFO_HTC ((XrStructureType) 1000324000U)
#define XR_TYPE_PERSISTED_ANCHOR_COLLECTION_ACQUIRE_COMPLETION_HTC ((XrStructureType) 1000324001U)
#define XR_TYPE_SPATIAL_ANCHOR_PERSIST_INFO_HTC ((XrStructureType) 1000324002U)
#define XR_TYPE_SPATIAL_ANCHOR_FROM_PERSISTED_ANCHOR_CREATE_INFO_HTC ((XrStructureType) 1000324003U)
#define XR_TYPE_SPATIAL_ANCHOR_FROM_PERSISTED_ANCHOR_CREATE_COMPLETION_HTC ((XrStructureType) 1000324004U)
#define XR_TYPE_PERSISTED_ANCHOR_PROPERTIES_GET_INFO_HTC ((XrStructureType) 1000324005U)
#define XR_ERROR_PERSISTED_ANCHOR_NAME_NOT_FOUND_HTC ((XrResult) -1000324000U)
#define XR_ERROR_PERSISTED_ANCHOR_DUPLICATED_HTC ((XrResult) -1000324001U)
typedef struct XrPersistedAnchorCollectionAcquireInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
} XrPersistedAnchorCollectionAcquireInfoHTC;

typedef struct XrPersistedAnchorCollectionAcquireCompletionHTC {
    XrStructureType                   type;
    const void* XR_MAY_ALIAS          next;
    XrResult                          futureResult;
    XrPersistedAnchorCollectionHTC    persistedAnchorCollection;
} XrPersistedAnchorCollectionAcquireCompletionHTC;

typedef struct XrSpatialAnchorPersistInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrSpace                     anchor;
    XrSpatialAnchorNameHTC      persistedAnchorName;
} XrSpatialAnchorPersistInfoHTC;

typedef struct XrSpatialAnchorFromPersistedAnchorCreateInfoHTC {
    XrStructureType                   type;
    const void* XR_MAY_ALIAS          next;
    XrPersistedAnchorCollectionHTC    persistedAnchorCollection;
    XrSpatialAnchorNameHTC            persistedAnchorName;
    XrSpatialAnchorNameHTC            spatialAnchorName;
} XrSpatialAnchorFromPersistedAnchorCreateInfoHTC;

typedef struct XrSpatialAnchorFromPersistedAnchorCreateCompletionHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    XrResult                    futureResult;
    XrSpace                     anchor;
} XrSpatialAnchorFromPersistedAnchorCreateCompletionHTC;

typedef struct XrPersistedAnchorPropertiesGetInfoHTC {
    XrStructureType             type;
    const void* XR_MAY_ALIAS    next;
    uint32_t                    maxPersistedAnchorCount;
} XrPersistedAnchorPropertiesGetInfoHTC;

typedef XrResult(XRAPI_PTR* PFN_xrAcquirePersistedAnchorCollectionAsyncHTC)(XrSession session, const XrPersistedAnchorCollectionAcquireInfoHTC* acquireInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrAcquirePersistedAnchorCollectionCompleteHTC)(XrFutureEXT future, XrPersistedAnchorCollectionAcquireCompletionHTC* completion);
typedef XrResult(XRAPI_PTR* PFN_xrReleasePersistedAnchorCollectionHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorAsyncHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, const XrSpatialAnchorPersistInfoHTC* persistInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrPersistSpatialAnchorCompleteHTC)(XrFutureEXT future, XrFutureCompletionEXT* completion);
typedef XrResult(XRAPI_PTR* PFN_xrUnpersistSpatialAnchorHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, const XrSpatialAnchorNameHTC* persistedAnchorName);
typedef XrResult(XRAPI_PTR* PFN_xrEnumeratePersistedAnchorNamesHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, uint32_t persistedAnchorNameCapacityInput, uint32_t* persistedAnchorNameCountOutput, XrSpatialAnchorNameHTC* persistedAnchorNames);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorFromPersistedAnchorAsyncHTC)(XrSession session, const XrSpatialAnchorFromPersistedAnchorCreateInfoHTC* spatialAnchorCreateInfo, XrFutureEXT* future);
typedef XrResult(XRAPI_PTR* PFN_xrCreateSpatialAnchorFromPersistedAnchorCompleteHTC)(XrFutureEXT future, XrSpatialAnchorFromPersistedAnchorCreateCompletionHTC* completion);
typedef XrResult(XRAPI_PTR* PFN_xrClearPersistedAnchorsHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection);
typedef XrResult(XRAPI_PTR* PFN_xrGetPersistedAnchorPropertiesHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, XrPersistedAnchorPropertiesGetInfoHTC* getInfo);
typedef XrResult(XRAPI_PTR* PFN_xrExportPersistedAnchorHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, const XrSpatialAnchorNameHTC* persistedAnchorName, uint32_t bufferCapacityInput, uint32_t* bufferCountOutput, char* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrImportPersistedAnchorHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, uint32_t bufferCount, const char* buffer);
typedef XrResult(XRAPI_PTR* PFN_xrGetPersistedAnchorNameFromBufferHTC)(XrPersistedAnchorCollectionHTC persistedAnchorCollection, uint32_t bufferCount, const char* buffer, XrSpatialAnchorNameHTC* name);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrAcquirePersistedAnchorCollectionAsyncHTC(
    XrSession                                   session,
    const XrPersistedAnchorCollectionAcquireInfoHTC* acquireInfo,
    XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrAcquirePersistedAnchorCollectionCompleteHTC(
    XrFutureEXT                                 future,
    XrPersistedAnchorCollectionAcquireCompletionHTC* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrReleasePersistedAnchorCollectionHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorAsyncHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    const XrSpatialAnchorPersistInfoHTC* persistInfo,
    XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrPersistSpatialAnchorCompleteHTC(
    XrFutureEXT                                 future,
    XrFutureCompletionEXT* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrUnpersistSpatialAnchorHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    const XrSpatialAnchorNameHTC* persistedAnchorName);

XRAPI_ATTR XrResult XRAPI_CALL xrEnumeratePersistedAnchorNamesHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    uint32_t                                    persistedAnchorNameCapacityInput,
    uint32_t* persistedAnchorNameCountOutput,
    XrSpatialAnchorNameHTC* persistedAnchorNames);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorFromPersistedAnchorAsyncHTC(
    XrSession                                   session,
    const XrSpatialAnchorFromPersistedAnchorCreateInfoHTC* spatialAnchorCreateInfo,
    XrFutureEXT* future);

XRAPI_ATTR XrResult XRAPI_CALL xrCreateSpatialAnchorFromPersistedAnchorCompleteHTC(
    XrFutureEXT                                 future,
    XrSpatialAnchorFromPersistedAnchorCreateCompletionHTC* completion);

XRAPI_ATTR XrResult XRAPI_CALL xrClearPersistedAnchorsHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection);

XRAPI_ATTR XrResult XRAPI_CALL xrGetPersistedAnchorPropertiesHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    XrPersistedAnchorPropertiesGetInfoHTC* getInfo);

XRAPI_ATTR XrResult XRAPI_CALL xrExportPersistedAnchorHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    const XrSpatialAnchorNameHTC* persistedAnchorName,
    uint32_t                                    bufferCapacityInput,
    uint32_t* bufferCountOutput,
...
XRAPI_ATTR XrResult XRAPI_CALL xrImportPersistedAnchorHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    uint32_t                                    bufferCount,
    const char* buffer);

XRAPI_ATTR XrResult XRAPI_CALL xrGetPersistedAnchorNameFromBufferHTC(
    XrPersistedAnchorCollectionHTC              persistedAnchorCollection,
    uint32_t                                    bufferCount,
    const char* buffer,
    XrSpatialAnchorNameHTC* name);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
#endif /* XR_HTC_anchor_persistence */
