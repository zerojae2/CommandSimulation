...
// XR_HTC_passthrough_configuration is a preprocessor guard. Do not pass it to API calls.
#define XR_HTC_passthrough_configuration 1
#define XR_HTC_passthrough_configuration_SPEC_VERSION 1
#define XR_HTC_PASSTHROUGH_CONFIGURATION_EXTENSION_NAME "XR_HTC_passthrough_configuration"
static const XrStructureType XR_TYPE_SYSTEM_PASSTHROUGH_CONFIGURATION_PROPERTIES_HTC = ((XrStructureType)1000328000U);
//#define XR_TYPE_SYSTEM_PASSTHROUGH_CONFIGURATION_PROPERTIES_HTC ((XrStructureType) 1000328000U)
#define XR_TYPE_PASSTHROUGH_CONFIGURATION_BASE_HEADER_HTC ((XrStructureType) 1000328001U)
#define XR_TYPE_PASSTHROUGH_CONFIGURATION_IMAGE_RATE_HTC ((XrStructureType) 1000328002U)
#define XR_TYPE_PASSTHROUGH_CONFIGURATION_IMAGE_QUALITY_HTC ((XrStructureType) 1000328003U)
#define XR_TYPE_EVENT_DATA_PASSTHROUGH_CONFIGURATION_IMAGE_RATE_CHANGED_HTC ((XrStructureType) 1000328050U)
#define XR_TYPE_EVENT_DATA_PASSTHROUGH_CONFIGURATION_IMAGE_QUALITY_CHANGED_HTC ((XrStructureType) 1000328051U)
typedef struct XrSystemPassthroughConfigurationPropertiesHTC {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
    XrBool32              supportsImageRate;
    XrBool32              supportsImageQuality;
} XrSystemPassthroughConfigurationPropertiesHTC;

typedef struct XR_MAY_ALIAS XrPassthroughConfigurationBaseHeaderHTC {
    XrStructureType       type;
    void* XR_MAY_ALIAS    next;
...
typedef struct XrEventDataPassthroughConfigurationImageRateChangedHTC {
    XrStructureType                           type;
    const void* XR_MAY_ALIAS                  next;
    XrPassthroughConfigurationImageRateHTC    fromImageRate;
    XrPassthroughConfigurationImageRateHTC    toImageRate;
} XrEventDataPassthroughConfigurationImageRateChangedHTC;

typedef struct XrEventDataPassthroughConfigurationImageQualityChangedHTC {
    XrStructureType                              type;
    const void* XR_MAY_ALIAS                     next;
    XrPassthroughConfigurationImageQualityHTC    fromImageQuality;
    XrPassthroughConfigurationImageQualityHTC    toImageQuality;
} XrEventDataPassthroughConfigurationImageQualityChangedHTC;

typedef XrResult(XRAPI_PTR* PFN_xrEnumeratePassthroughImageRatesHTC)(XrSession session, uint32_t imageRateCapacityInput, uint32_t* imageRateCountOutput, XrPassthroughConfigurationImageRateHTC* imageRates);
typedef XrResult(XRAPI_PTR* PFN_xrGetPassthroughConfigurationHTC)(XrSession session, XrPassthroughConfigurationBaseHeaderHTC* config);
typedef XrResult(XRAPI_PTR* PFN_xrSetPassthroughConfigurationHTC)(XrSession session, const XrPassthroughConfigurationBaseHeaderHTC* config);

#ifndef XR_NO_PROTOTYPES
#ifdef XR_EXTENSION_PROTOTYPES
XRAPI_ATTR XrResult XRAPI_CALL xrEnumeratePassthroughImageRatesHTC(
    XrSession                                   session,
    uint32_t                                    imageRateCapacityInput,
    uint32_t* imageRateCountOutput,
    XrPassthroughConfigurationImageRateHTC* imageRates);

XRAPI_ATTR XrResult XRAPI_CALL xrGetPassthroughConfigurationHTC(
    XrSession                                   session,
    XrPassthroughConfigurationBaseHeaderHTC* config);

XRAPI_ATTR XrResult XRAPI_CALL xrSetPassthroughConfigurationHTC(
    XrSession                                   session,
    const XrPassthroughConfigurationBaseHeaderHTC* config);
#endif /* XR_EXTENSION_PROTOTYPES */
#endif /* !XR_NO_PROTOTYPES */
