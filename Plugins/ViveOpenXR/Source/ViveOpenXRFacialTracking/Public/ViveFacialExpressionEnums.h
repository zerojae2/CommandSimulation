...
enum class ELipShape :uint8 {
	...
	Mouth_Raiser_Right = 12     UMETA(DisplayName = "Mouth_Raiser_Right"),
	Mouth_Raiser_Left = 13      UMETA(DisplayName = "Mouth_Raiser_Left"),
	Mouth_Stretcher_Right = 14  UMETA(DisplayName = "Mouth_Stretcher_Right"),
	Mouth_Stretcher_Left = 15   UMETA(DisplayName = "Mouth_Stretcher_Left"),
